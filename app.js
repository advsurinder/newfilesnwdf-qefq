...
document.getElementById('v-printBtn').onclick = ()=>{
  document.getElementById('v-printGrid').innerHTML = vaultLastBatch.map(c=>`
    <div class="v-print-card">
      <div class="pc-eyebrow">The Sector 17 · Secret Code</div>
      <div class="pc-title">A reward is waiting</div>
      <div class="pc-code">${c.code}</div>
      <div class="pc-note">Text this code to our WhatsApp, or drop it in the comments on your next order to see what you won.</div>
    </div>
  `).join('');
  window.print();
};
