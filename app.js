  ...
  return `<div class="grocery-item">
    ...
    <div style="display:flex;flex-direction:column;gap:6px;align-items:stretch;">
      ...
      <div style="display:flex;gap:4px;">
        <button class="btn-outline" data-grocery-edit="${item.id}" title="Edit"><i class="ti ti-edit" aria-hidden="true"></i></button>
        <button class="btn-outline" data-grocery-fav="${item.id}" title="Favorite"><i class="ti ti-star${item.favorite?'-filled':''}" aria-hidden="true"></i></button>
        <button class="btn-outline" data-grocery-dup="${item.id}" title="Duplicate"><i class="ti ti-copy" aria-hidden="true"></i></button>
        <button class="btn-danger" data-grocery-delete="${item.id}" title="Delete"><i class="ti ti-trash" aria-hidden="true"></i></button>
      </div>
    </div>
  </div>`;
}
