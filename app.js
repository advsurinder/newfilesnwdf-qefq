...
const VAULT_PUBLIC_URL = 'https://www.thesector17.com/rewards';
let vaultCodes = [];
...
document.getElementById('v-printBtn').onclick = async ()=>{
  ...
  try{
    ...
    document.getElementById('v-printGrid').innerHTML = cardsHtml.join('');
    window.print();
  }catch(e){
...
function vaultCouponCardHtml(c, qr, style){
  const note = `Scan, or enter this code at <strong>thesector17.com/rewards</strong>.<br>One-time use — verified at checkout.`;
  if(style === 'ticket'){
    return `
      <div class="v-print-card style-ticket">
        <div class="pc-main">
          <img class="pc-logo" src="logo.png" alt="The Sector 17">
...
document.getElementById('v-pdfBtn').onclick = async ()=>{
  ...
  try{
    ...
    const logoImg = document.getElementById('couponLogoImg');
    const logoRatio = (logoImg.naturalHeight && logoImg.naturalWidth) ? logoImg.naturalHeight / logoImg.naturalWidth : 0.27;
...
const VAULT_PDF_FOOTER_1 = 'Scan, or enter this code at thesector17.com/rewards.';
